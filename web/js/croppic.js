...
(function (window, document) {
    ...
    initCropper: function(){
        ...
        that.img.wrap('<div class="cropImgWrapper" style="position:absolute; overflow:hidden; z-index:1; width:'+that.objW+'px; height:'+that.objH+'px; border-radius:50%;"></div>');
    ...
    createCropControls: function(){
        ...
        html =  '<div class="cropControls cropControlsCrop">' + cropControlZoomIn + cropControlZoomOut + cropControlReset + '</div>';
        ...
        that.cropControlZoomIn.on('click',function(){ that.zoom(that.options.zoomFactor * 5); });

        that.cropControlZoomOut = that.cropControlsCrop.find('.cropControlZoomOut');
        that.cropControlZoomOut.on('click',function(){ that.zoom(-that.options.zoomFactor * 5); });
        ...
        initDrag:function(){
            ...
            that.img.on("mousedown", function(e) {
                ...
                that.img.css('z-index', 1).on("mousemove", function(e) {
