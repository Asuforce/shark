...
insert into profile(user_id, sex, introduction,pro_image) values(1, 0, 'いちきです。', '/SHARK/shark0_13/web/profile_image/ichiki.jpg');
insert into profile(user_id, sex, introduction,pro_image) values(2, 0, 'ひろあきです。', '/SHARK/shark0_13/web/profile_image/hiroaki.jpg');
insert into profile(user_id, sex, introduction,pro_image) values(3, 1, 'はるなです。', '/SHARK/shark0_13/web/profile_image/haruna.jpg');
insert into profile(user_id, sex, introduction,pro_image) values(4, 0, 'しゅんです。', '/SHARK/shark0_13/web/profile_image/shun.jpg');
insert into profile(user_id, sex, introduction,pro_image) values(5, 0, 'はやとです。', '/SHARK/shark0_13/web/profile_image/hayato.jpg');
insert into profile(user_id, sex, introduction,pro_image) values(6, 0, 'たかひろです。', '/SHARK/shark0_13/web/profile_image/takahiro.jpg');
insert into profile(user_id, sex, introduction,pro_image) values(7, 0, 'けいすけです。', '/SHARK/shark0_13/web/profile_image/keisuke.jpg');
insert into profile(user_id, sex, introduction,pro_image) values(8, 1, 'ようこです。', '/SHARK/shark0_13/web/profile_image/yoko.jpg');
...
insert into instrument(instrument_id, instrument_name, instrument_image) values(1, 'ボーカル', '/SHARK/shark0_13/web/instrument_icon/vocal.png');
insert into instrument(instrument_id, instrument_name, instrument_image) values(2, 'ギター', '/SHARK/shark0_13/web/instrument_icon/guitar.png');
insert into instrument(instrument_id, instrument_name, instrument_image) values(3, 'ベース', '/SHARK/shark0_13/web/instrument_icon/bass.png');
insert into instrument(instrument_id, instrument_name, instrument_image) values(4, 'ドラム', '/SHARK/shark0_13/web/instrument_icon/drum.png');
insert into instrument(instrument_id, instrument_name, instrument_image) values(5, 'その他', '/SHARK/shark0_13/web/instrument_icon/other.png');
